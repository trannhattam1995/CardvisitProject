...
class Information_Register : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var phone_number_d = sharedPreferences.getString("PHONE_NUNBER","")
        ...
        back_bt.setOnClickListener({
            ...
            phone_number_d = department.text.toString().trim()
            email_d = email.text.toString().trim()
            fax_number_d = department.text.toString().trim()
            ...
            editor.putString("PHONE_NUNBER", phone_number_d)
